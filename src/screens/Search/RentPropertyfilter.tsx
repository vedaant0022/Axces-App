  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F2F8F6] relative">
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 8 }}>
        <Text style={{ fontSize: 16, color: '#0E0E0C', fontWeight: 'bold' }}>Rent Range</Text>
        <Text style={{ fontSize: 16, color: '#BDEA09', fontWeight: 'bold' }}>{formatRentPrice(Rentprice)}</Text>
      </View>
      <Slider
        style={{ width: '100%', height: 40 }}
        minimumValue={0}
