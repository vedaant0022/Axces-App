export const demoBuilding =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712222593/demoBuilding_tedbwl.jpg';
export const rightArrow =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712225225/axcesRightArrow_b2vgm9.png';
export const axcesLogoWhite =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712232360/AxcesLogoWhiteBg_skblze.png';
export const activeHome =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712528787/ActiveHome_mz25nf.png';
export const inactiveHome =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712529914/InActiveHome_sanvvr.png';
export const homeBanner =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712531191/Rectangle_3463371_hkrmh5.png';
export const greenDown =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712532498/greenDown_ghd4nr.png';
export const location =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712532447/location_mlk3es.png';
export const bell =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712533182/notification_fso9vy.png';
export const searchIcon =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712533821/Search_x9jcvf.png';
export const key =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712534366/key_ciu141.png';
export const buyHouse =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712534371/house_a9flfm.png';
export const showcaseHome =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712553639/ShowcaseHome_1_intsk1.png';
export const faqChatBot =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712557067/FaqChatbot_azafqo.png';
export const offerBanner =
  'https://res.cloudinary.com/krishanucloud/image/upload/v1712558024/offerBanner_e5egpm.png';
...
export const activeProfileTabIc =
...
export const Privacy =
  'https://cdn-icons-png.flaticon.com/512/7358/7358460.png';
